    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-[200px] justify-between bg-white/20 text-white backdrop-blur-sm border border-white/20 rounded-lg"
        >
          {value ? (
            ...
            <span className="flex items-center gap-2 font-normal">
              {countries.find((country) => country.value === "usa")?.flag}
              {countries.find((country) => country.value === "usa")?.label}
            </span>
          )}
